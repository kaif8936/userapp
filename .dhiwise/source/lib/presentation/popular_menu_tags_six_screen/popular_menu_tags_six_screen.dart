import '../popular_menu_tags_six_screen/widgets/chipview10_item_widget.dart';
import '../popular_menu_tags_six_screen/widgets/chipview_one10_item_widget.dart';
import '../popular_menu_tags_six_screen/widgets/chipview_two10_item_widget.dart';
...
class PopularMenuTagsSixScreen extends StatelessWidget {
  PopularMenuTagsSixScreen({Key? key})
      : super(
          key: key,
        );
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    spacing: 15.h,
                    children: List<Widget>.generate(
                        4, (index) => ChipviewOne10ItemWidget()),
                  ),
                  SizedBox(height: 26.v),
                  Text(
                    "lbl_food".tr,
                  ...
                  Wrap(
                    ...
                    spacing: 9.h,
                    children: List<Widget>.generate(
                        5, (index) => ChipviewTwo10ItemWidget()),
                  ),
