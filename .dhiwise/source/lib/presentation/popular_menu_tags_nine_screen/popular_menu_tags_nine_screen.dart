import '../popular_menu_tags_nine_screen/widgets/chipview8_item_widget.dart';
import '../popular_menu_tags_nine_screen/widgets/chipview_one8_item_widget.dart';
import '../popular_menu_tags_nine_screen/widgets/chipview_two8_item_widget.dart';
...
class PopularMenuTagsNineScreen extends StatelessWidget {
  PopularMenuTagsNineScreen({Key? key})
      : super(
          key: key,
        );
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                spacing: 10.h,
                children:
                    List<Widget>.generate(3, (index) => Chipview8ItemWidget()),
              ),
              ...
              Wrap(
                ...
                children: List<Widget>.generate(
                    4, (index) => ChipviewOne8ItemWidget()),
              ),
              SizedBox(height: 26.v),
              Text(
                "lbl_food".tr,
              ...
              Wrap(
                ...
                spacing: 9.h,
                children: List<Widget>.generate(
                    5, (index) => ChipviewTwo8ItemWidget()),
              ),
              SizedBox(height: 5.v),
            ],
          ),
