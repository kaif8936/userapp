import '../popular_menu_tags_two_screen/widgets/chipview2_item_widget.dart';
import '../popular_menu_tags_two_screen/widgets/chipview_one2_item_widget.dart';
import '../popular_menu_tags_two_screen/widgets/chipview_two2_item_widget.dart';
...
class PopularMenuTagsTwoScreen extends StatelessWidget {
  PopularMenuTagsTwoScreen({Key? key})
      : super(
          key: key,
        );
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    spacing: 16.h,
                    children: List<Widget>.generate(
                        4, (index) => ChipviewOne2ItemWidget()),
                  ),
                  SizedBox(height: 25.v),
                  Text(
                    "lbl_food".tr,
                  ...
                  Wrap(
                    ...
                    spacing: 16.h,
                    children: List<Widget>.generate(
                        5, (index) => ChipviewTwo2ItemWidget()),
                  ),
